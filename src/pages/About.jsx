        ...
        <div className="flex flex-wrap lg:items-center">
          <div className="w-full px-4 mb-10 lg:w-1/2">
            ...
            <p className="font-medium text-base text-secondaryls max-w-md">
              ...
              ipsam repellendus alias quam voluptatum, aspernatur suscipit,
              quaerat reiciendis provident voluptas cumque sint magnam facere.
              Aut, recusandae! Amet beatae qui autem.
            </p>
          </div>
          <div className="w-full px-4 lg:w-1/2">
            <h4 className="text-2xl font-semibold mb-4">Get closer with me</h4>
